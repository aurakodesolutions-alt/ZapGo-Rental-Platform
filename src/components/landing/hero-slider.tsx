                                    ...
                                    <div className="container mx-auto px-4 text-center md:text-left">
                                        <div className="max-w-3xl">
                                            ...
                                            <div className="mt-8 flex flex-col sm:flex-row justify-center md:justify-start items-center gap-4">
                                                ...
                                                <Button size="lg" variant="outline" asChild className="w-full sm:w-auto text-black border-white hover:bg-white hover:text-secondary shadow-lg hover:scale-105 transition-transform duration-300">
